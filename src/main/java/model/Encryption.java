...
public class Encryption {
    ...
    public static String encrypt(String userEmail, String password){
    	try {
		    ...
		    SecretKey aesKeyFromPassword = getAESKeyFromPassword(userEmail.toCharArray(), salt);
    ...
    public static String decrypt(String encryptedPassword, String userEmail) {
		try {
			...
			SecretKey aesKeyFromPassword = Encryption.getAESKeyFromPassword(userEmail.toCharArray(), salt);
